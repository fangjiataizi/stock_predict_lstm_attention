...
def train():
    ...
    model = RNN_BASE(input_size=args.input_size, hidden_size=args.hidden_size, num_layers=args.layers , output_size=1, dropout=args.dropout, batch_first=args.batch_first) #创建LSTM()类的一个对象
    ...
    for i in range(args.epochs):
        ...
        if i % 10 == 0:
            ...
            torch.save({'state_dict': model.state_dict()}, args.save_file_RNN)
